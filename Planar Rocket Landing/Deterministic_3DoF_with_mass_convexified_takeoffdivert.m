...
glideslope_STC_constraint = {round(N / 2):N, @(t, x, u, p, x_ref, u_ref, p_ref, k) 1e4 * (norm(x(1:2, k)) - x(2, k) / cos(glideslope_STC_angle)) * (x_ref(2, k) <= glideslope_STC_trigger_height)};
