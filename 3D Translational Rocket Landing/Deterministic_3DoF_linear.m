...
% Description: 3DoF (all translational) landing of rocket using PTR SCP 
% algorithm using lossless convexification
% Most Recent Change: 1 September, 2025
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
