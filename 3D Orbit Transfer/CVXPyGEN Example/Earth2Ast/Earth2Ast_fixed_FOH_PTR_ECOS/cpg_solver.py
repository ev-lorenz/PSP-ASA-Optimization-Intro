...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.constraints[17].save_dual_value(np.array(res.cpg_dual.d17).reshape((3, 3), order='F'))
    ...
    prob.constraints[20].save_dual_value(np.array(res.cpg_dual.d20).reshape((6, 6), order='F'))
